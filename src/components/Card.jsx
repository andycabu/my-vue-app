...
function Card() {
  ...
  const Cards = [
    {
      ...
      description:
        "Pagina para poder ver los productos que se encuentran en la base de datos, podemos añadir, modificar y eliminar productos.",
      icon: (
        <svg
          viewBox="0 0 24 24"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Pagina para poder ver las tareas que se encuentran en la base de datos, podemos añadir, modificar y eliminar tareas.",
      icon: (
        <svg
          viewBox="0 0 24 24"
          fill="none"
  ...
  return (
    <div className="grid">
      {Cards.map((task) => (
        <div key={task.id} className="card box-shadow-1" onClick={task.click}>
